...
#=======================================================
              ...
              if msg.from_ in admin:
                msg.contentType = 13
                msg.contentMetadata = {'u35577e52b245ace6deb64e33a301f3b0'}
                cl.sendMessage(msg)
#-----------------=============================   
	      ...
	      if msg.from_ in admin:
                ...
                cl.sendMessage(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
...
#==================================================================
              ...
              if msg.from_ in admin:
                ...
                msg.contentMetadata = {'u35577e52b245ace6deb64e33a301f3b0'}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"owner ╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩ :ŚhÀH•ŹÀ!η࿐❥")
            elif "Admin on @",".admin @" in msg.text:
                if msg.from_ in owner:
                    print "[Command]Staff add executing"
                    _name = msg.text.replace("Admin on @",".admin @")
...
#=================================================================
              ...
              if msg.from_ in admin:
				try:
					...
					pass
#================================================================           
            elif msg.text in ["Invite user",".invite"]:
              if msg.from_ in admin:
                 wait["winvite"] = True
...
#=======================================================
	      ...
	      if msg.from_ in admin:
                if wait["Protectcancl"] == True:
		    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cancel Semua Invitation On")
                    else:
                        cl.sendText(msg.to,"done")
                else:
              ...
              if msg.from_ in admin:
                if wait["Protectcancl"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cancel Semua Invitation Off")
                    else:
                        cl.sendText(msg.to,"done")
                else:
		    wait["Protectcancl"] = False
              ...
              if msg.from_ in admin:
                if wait["Protectjoin"] == True:
		    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"That Cancel Invitation We Kick")
                    else:
                        cl.sendText(msg.to,"done")
                else:
              ...
              if msg.from_ in admin:
                if wait["Protectcancel"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"That Cancel Invitation Not We Kick")
                    else:
                        cl.sendText(msg.to,"done")
                else:
		    wait["Protectcancel"] = False
		        ...
		        cl.sendText(msg.to,"That Cancel Invitation Not We Kick")
                        ...
                        cl.sendText(msg.to,"done")
	    elif msg.text in ["Qr on","qr on",".open"]:
              if msg.from_ in admin:
		if wait["Protectgr"] == True:
                    if wait["lang"] == "JP":
			...
			cl.sendText(msg.to,"Protect QR On")
                        ...
                        cl.sendText(msg.to,"done")
	    elif msg.text in ["Qr off","qr off",".close"]:
              if msg.from_ in admin:
...
#=========================================================================
	    ...
	    elif msg.text in ["è‡ªå‹•å�‚åŠ :ã‚ªãƒ³","Join on","Auto join on",".autojoin on"]:
              if msg.from_ in admin:
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
	    elif msg.text in ["è‡ªå‹•å�‚åŠ :ã‚ªãƒ•","Join off","Auto join off",".autojoin off"]:
              if msg.from_ in admin:
		if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already off")
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Auto leave:on","autoleave:on"]:
              if msg.from_ in admin:
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
            ...
            elif msg.text in ["Auto leave:off","autoleave:off"]:
              if msg.from_ in admin:
...
#==========================================================
            ...
            elif msg.text in ["Settings","Set",".settings"]:
              if msg.from_ in admin:
            	print "Setting pick up..."
                md="⚝▪☆●╔⪨⪩┅༐┅͜͡❇ℜ𝔞𝔰𝔠𝔞𝔩𝔰 𝔖𝔮𝔲𝔞𝔡║❇͜͡┅༐┅⪨⪩●☆▪⚝ Settings\n\n"
...
#------------------------------------------------
              ...
              if msg.from_ in admin:
                ki.sendText(msg.to,"PONG 􀨁􀄻double thumbs up􀜁􀅔 ")
                kk.sendText(msg.to,"PONG 􀨁􀄻double thumbs up􀜁􀅔 ")
                kc.sendText(msg.to,"PONG 􀨁􀄻double thumbs up􀜁􀅔 ")
                ks.sendText(msg.to,"PONG 􀨁􀄻double thumbs up􀜁􀅔 ")
                kt.sendText(msg.to,"PONG 􀨁􀄻double thumbs up􀜁􀅔 ")
                cl.sendText(msg.to,"PONG 􀨁􀄻double thumbs up􀜁􀅔 ")
...
#===========================================
	    ...
	    elif msg.text in ["Absen","Respon",".name"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                ki.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                kk.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                kc.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                ks.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                ka.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                kb.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                ko.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                ke.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                kt.sendText(msg.to,"ŚhÀH•ŹÀ!η࿐❥")
                random.choice(KAC).sendText(msg.to,"All Already Present Boss\nReady to Protect Group\nNo Safe Ammunition That Is Important")
#========================================
...
#========================================
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Not bisa dilakukan di luar grup")
                    ...
                    if msg.from_ in admin:
                        ...
                        for g in gs.members:
                            if _nametarget == g.displayName:
                                targets.append(g.mid)
                        if targets == []:
                            cl.sendText(msg.to, "Not Ada Target Copy")
                        else:
                            for target in targets:
                                try:
                                    cl.CloneContactProfile(target)
		...
		kt.sendText(msg.to, "%sseconds" % (elapsed_time))
                           ...
                           for target in targets:
                               if not target in Bots:
                                   try:
                                       ...
                                       cl.sentText(msg.to,"Successfully Deleted")
              ...
              if msg.from_ in admin:
                ...
                if msg.from_ in admin:
                    ...
                    if gid in [""," "]:
                        cl.sendText(msg.to,"Grup id Not valid")
                    else:
                        try:
...
#--------------------------------------------------------
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Special Admin")
#--------------------------------------------------------
...
#--------------------------------------------------------
		...
		try:
		    if msg.from_ in Creator:
		        ...
		        cl.sendText(msg.to,"Special Creator")
		except Exception as e:
                ...
                if targets ==[]:
                        ...
                        for target in targets:
                                try:
                                        ...
                                        satpam.sendText(msg.t,"TERMINATED....")
                ...
                if msg.toType == 2:
                    ...
                    for g in gs.members:
                        if _name in g.displayName:
                            targets.append(g.mid)
                    if targets == []:
		        kr.sendText(msg.to,"Not ditemukan")
                    else:
		        for target in targets:
                          if not target in Bots:
...
#========================================
              ...
              if msg.from_ in admin:
                ginfo = cl.getGroup(msg.to)
                random.choice(KAC).sendText(msg.to,"Welcome to The group" + str(ginfo.name))
                random.choice(KAC).sendText(msg.to,"Owner Group " + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
#=========================================
...
#-----------------------------------------------
         #   elif 'apakah' in msg.text.lower():
          #    if msg.from_ in admin:
           ...
           #     jawab = ("Ya","Not","Mungkin","Bisa jadi")
...
#========================================
            elif msg.text in ["Beb","Say",".joinall"]:
              if msg.from_ in admin:
	    ...
	    elif msg.text in ["Masuk",".join","In"]:
              if msg.from_ in admin:
...
#=====================================================================================
            ...
            elif msg.text in ["Keluar",".byeall","Byeall"]:
              if msg.from_ in owner:
				gid = cl.getGroupIdsJoined()
				for i in gid:
                        cl.leaveGroup(i)
            ...
            elif msg.text in ["Putus","Break",".bye"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                   X = cl.getGroup(msg.to)
                try:
...
#-----------------------------------------------------------
            ...
            elif msg.text in ["Clear banlist",".clearban"]:
              if msg.from_ in admin:
				wait["blacklist"] = {}
				cl.sendText(msg.to,"succes clear all banlist")
				
            elif msg.text in ["Banned",".ban"]:
              if msg.from_ in admin:
                wait["wblacklist"] = True
                cl.sendText(msg.to,"send contact to ban")
            
            elif msg.text in ["Unbanned",".unban"]:
              if msg.from_ in admin:
                wait["dblacklist"] = True
                cl.sendText(msg.to,"send contact to ban")
			
            elif msg.text in ["Banlist",".blc"]:
              if msg.from_ in admin:
                if wait["blacklist"] == {}:
                    cl.sendText(msg.to,"nothing") 
                else:
...
#============================================
            ...
            elif msg.text.lower() in [".tagall","Tag","mention all"]:
              if msg.from_ in admin:
                group = cl.getGroup(msg.to)
